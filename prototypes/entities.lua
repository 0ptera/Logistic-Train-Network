...
ltn_stop_in.collision_mask = {"rail-layer"} -- disable collision with other entities
...
ltn_stop_out.collision_mask = {"rail-layer"} -- disable collision with other entities
...
ltn_lamp_control.collision_mask = {"rail-layer"} -- disable collision with other entities
